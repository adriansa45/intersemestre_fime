...
import 'package:intersemestral_fime/pages/student/subjects.dart';
...
class StudentAcademyPage extends StatefulWidget {
  ...
  const StudentAcademyPage({super.key, required this.department});

  @override
  _StudentAcademyPageState createState() => _StudentAcademyPageState();
}
                        ...
                        child: ButtonWithImage(
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      StudentSubjectsPage(academy: item.id)),
                            );
                          },
                        ),
                      );
